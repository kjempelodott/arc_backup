...
/*
  Forward declaration of PyObject. We don't want to include Python.h here
  as Python.h has to be included first, else there will be 'xxx redefined'
  warnings at compile time. Include Python.h in the .cpp file, which
  is not included in other pieces of code.
*/
#ifndef Py_PYTHON_H
class PyObject;
#endif
